    ...
    describe("재고 예약") {
        context("정상적인 예약 요청일 때") {
            it("재고를 예약할 수 있다") {
                ...
                inventoryCommandUseCase.createInventory(productId, initialStock, 0L)
        ...
        context("예약 만료 처리") {
            it("만료된 예약들을 일괄 처리한다") {
                ...
                inventoryCommandUseCase.createInventory(productId1, initialStock, 0L)
                inventoryCommandUseCase.createInventory(productId2, initialStock, 0L)
