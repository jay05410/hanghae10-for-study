package io.hhplus.ecommerce.point.presentation.controller
...
import io.hhplus.ecommerce.point.presentation.dto.PointHistoryResponse
import io.hhplus.ecommerce.point.presentation.dto.UserPointResponse
import io.hhplus.ecommerce.point.presentation.dto.toResponse
...
/**
 * 포인트 API 컨트롤러 - Presentation Layer
 *
 * 역할:
...
class PointController(
    ...
    fun usePoint(
        ...
        val userPoint = usePointUseCase.execute(userId, request.amount, request.description)
        return ApiResponse.success(userPoint.toResponse())
    }
