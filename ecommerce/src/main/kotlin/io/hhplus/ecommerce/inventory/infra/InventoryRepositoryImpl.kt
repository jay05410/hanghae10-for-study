...
import io.hhplus.ecommerce.inventory.infra.mapper.InventoryMapper
import io.hhplus.ecommerce.inventory.infra.mapper.toDomain
import io.hhplus.ecommerce.inventory.infra.mapper.toEntity
import io.hhplus.ecommerce.inventory.infra.persistence.repository.InventoryJpaRepository
import org.springframework.stereotype.Repository

/**
 * Inventory Repository JPA 구현체
 *
 * 역할:
