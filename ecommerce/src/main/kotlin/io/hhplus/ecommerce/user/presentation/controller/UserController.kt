...
import io.hhplus.ecommerce.user.presentation.dto.*
...
class UserController(
    ...
    fun updateUser(
        ...
        val user = userCommandUseCase.updateUser(
            userId = userId,
            name = request.name,
            email = request.email
        )
    ...
    fun getAllUsers(): ApiResponse<List<UserResponse>> {
        val users = getUserQueryUseCase.getAllActiveUsers()
    ...
    fun deactivateUser(
        ...
        val user = userCommandUseCase.deleteUser(userId)
        return ApiResponse.success(user.toResponse())
    }
    ...
    fun activateUser(
        ...
        val user = userCommandUseCase.restoreUser(userId)
        return ApiResponse.success(user.toResponse())
    }
}
